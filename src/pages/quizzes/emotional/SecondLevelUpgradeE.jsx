            ...
            {currentQuestion < questions.length ? (
                <Box display="flex" flexDirection="column" height="90%" justifyContent="space-between" >
                    <div className={classes.textWrapper}>
                        ...
                        {(currentQuestion === 0) && (
                            <>
                              <p>علم نشان می‌دهد که مغز ما از طریق احساسات در بدنمان با ما صحبت می‌کند. این «زبان بدن» کلید ولنس احساسی است. مطالعات حاکی از آن است که نواحی عمیق در مغز، مانند آمیگدال، از احساسات (Sensations) به عنوان راهی برای برقراری ارتباط با عواطف (Emotions) استفاده می‌کنند. با آگاهی از این سیگنال‌های بدنی (Interception)، می‌توانیم استرس را بهتر کنترل کنیم و چالش‌های زندگی را مدیریت کنیم. علاوه بر این، کلماتی که برای توصیف احساسات خود استفاده می‌کنیم، می‌توانند بر نحوه تجربه ما تأثیر بگذارند. این نشان می‌دهد که هم زبان احساسات بدن و هم زبان کلمات در قشر جلوی مغز نقشی در ولنس احساسی ما دارند.</p>
                            </>
                        )}
                        {(currentQuestion === 1) && (
                          <>
                            <p>حس یک تجربه روان‌شناختی پیچیده و چندوجهی است که منشأ آن در ناخودآگاه است. احساسات می‌توانند توسط افکار، باورها، خواسته‌ها و موقعیت‌ها برانگیخته شوند، اما خود تجربه حس خارج از ضمیر آگاخ ما قرار می‌گیرد.</p>
                          </>
                        )}
                        {(currentQuestion === 2) && (
                            <>
                              <p>دانشمندانی که احساسات را مطالعه می کنند به طور کلی موافق هستند که ۶ احساس اساسی وجود دارد که همه افراد بدون توجه به پیشینه یا تربیت تجربه می کنند. این احساسات ماهیت پویایی دارند که دائماً شدت و فرکانس احساس آن‌ها تغییر می‌کنند.
در اینجا نگاهی به هر یک از این شش دسته می‌اندازیم:</p>
                            </>
                        )}
                        {(currentQuestion === 3) && (
                           <>
...
export default SecondLevelUpgradeE;
